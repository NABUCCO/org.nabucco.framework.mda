...
/**
 * XmlTemplateFileVisitor
 * 
 * @author Nicolas Moser, PRODYNA AG
 */
class XmlTemplateFileVisitor extends FileTreeVisitor {

    private Map<String, String> templateFileMap;

    public XmlTemplateFileVisitor(Map<String, String> templateFileMap) {
    ...
    protected void visitArchive(File zipFile) throws IOException {
        ...
        XmlTemplateFileFilter filter = XmlTemplateFileFilter.getInstance();
