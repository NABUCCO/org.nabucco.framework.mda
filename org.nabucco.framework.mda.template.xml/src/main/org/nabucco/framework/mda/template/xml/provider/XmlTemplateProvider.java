 ...
 */
public interface XmlTemplateProvider extends MdaTemplateProvider<XmlModel>, XmlTemplateConstants {

    public abstract XmlTemplate provideTemplate(String id) throws XmlTemplateException;
