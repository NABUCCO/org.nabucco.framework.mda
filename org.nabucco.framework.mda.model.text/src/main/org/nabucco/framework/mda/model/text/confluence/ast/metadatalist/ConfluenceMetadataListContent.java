...
/**
 * ConfluenceMetadataListText
 * 
 * @author Leonid Agranovskiy, PRODYNA AG
 */
public class ConfluenceMetadataListContent extends ConfluenceComposite {

    private static final long serialVersionUID = 1L;

    public ConfluenceMetadataListContent() {
    }
    
    public ConfluenceMetadataListContent(ConfluenceElement text) {
