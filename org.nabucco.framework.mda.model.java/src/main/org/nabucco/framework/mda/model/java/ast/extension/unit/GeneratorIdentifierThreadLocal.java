...
public final class GeneratorIdentifierThreadLocal {
     ...
     */
    private GeneratorIdentifierThreadLocal() {
    }

    /**
     * Sets the generator identifier to the thread-local variables.
     * 
     * @param generatorIdentifier
     *            the generator identifier to set into the thread-local variables
     */
    public static final void setGeneratorIdentifier(String generatorIdentifier) {
        THREAD_LOCAL.set(generatorIdentifier);
    }
     ...
     */
    public static final String getGeneratorIdentifier() {
